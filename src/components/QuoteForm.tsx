          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-gray-800/50 border border-green-500/50 rounded-2xl p-12 shadow-2xl">
              ...
              <p className="text-orange-400 font-semibold">
                For emergency requests, call us directly at <a href="tel:07799123456" className="underline hover:text-orange-300">07799 123456</a>
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-8 shadow-2xl">
                ...
                <p className="text-xs text-gray-400 text-center mt-4">
                  By submitting this form, you agree to our privacy policy. We'll only use your information to provide quotes and service updates.
                </p>
              </form>
            </div>
          </div>
